I built a server-side, non-relational database (noSQL) containing information about movies, directors and genres. Database is deployed on MongoDB and hosted on Heroku. 
